...
btn = Text(form_box, grid=[0,0], text="  ", align="center" )
btn = PushButton(form_box, grid=[1,0], text=" ↑ ", align="center" )
btn.font = font
btn = Text(form_box, grid=[2,0], text="  ", align="center" )
...
btn = Text(form_box, grid=[0,2], text="  ", align="center")
btn = PushButton(form_box, grid=[1,2], text=" ↓ ", align="center")
btn.font = font
btn = Text(form_box, grid=[2,2], text="  ", align="center")
