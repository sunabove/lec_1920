...
alias cam="raspivid -t 999999 -fps 25 -b 2000000 -vf -hf -n -o - | tee video_`date '+%Y-%m-%d_%H:%M:%S'`.h264 | gst-launch-1.0 -v fdsrc ! h264parse ! rtph264pay ! udpsink host=`who --ips | grep -m1 '' | awk '{print $5}'` port=5600"
